...
import com.github.printa.arsenal.client.gui.WeaponWorkbench_GUI;
...
import com.github.printa.arsenal.client.render.blockentity.Weapon_Workbench_Block_Renderer;
...
import com.github.printa.arsenal.server.registries.*;
...
import com.github.printa.arsenal.setup.ClientProxy;
import com.github.printa.arsenal.setup.CommonProxy;
...
public class Arsenal {
    ...
    static {
        NetworkRegistry.ChannelBuilder channel = NetworkRegistry.ChannelBuilder.named(ResourceLocation.fromNamespaceAndPath(MODID, "main_channel"));
    ...
    public Arsenal() {
        ...
        CreativeTabRegistry.DEF_REG.register(bus);
    ...
    private void clientSetup(final FMLClientSetupEvent e) {
        MenuScreens.register(MenuRegistry.WEAPON_WORKBENCH.get(), WeaponWorkbench_GUI::new);

        BlockEntityRenderers.register(BlockEntityRegistry.WEAPON_WORKBENCH.get(), Weapon_Workbench_Block_Renderer::new);
    }
    ...
    private void setup(final FMLCommonSetupEvent event) {
        ...
        event.enqueueWork(ItemRegistry::initDispenser);
        event.enqueueWork(JigsawRegistry::registerJigsawElements);
    }

    public static ResourceLocation id(@NotNull String path) {
        return ResourceLocation.fromNamespaceAndPath(Arsenal.MODID, path);
    }
}