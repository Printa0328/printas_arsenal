...
public class ServerEventHandler {
    ...
    public static void onPlayerAttack(AttackEntityEvent event) {
        ...
        if (event.isCancelable() && event.getEntity().hasEffect(EffectRegistry.EFFECTSTUN.get())) {
    ...
    public void onLivingJump(LivingEvent.LivingJumpEvent event) {
        ...
        if (entity.getEffect(EffectRegistry.EFFECTSTUN.get()) != null){
    ...
    public void onPlayerLeftClick(PlayerInteractEvent.LeftClickBlock event) {
        ...
        if (event.isCancelable() && player.hasEffect(EffectRegistry.EFFECTSTUN.get())) {
            event.setCanceled(true);
        }
    }
    ...
    public void onUseItem(LivingEntityUseItemEvent event) {
        ...
        if (event.isCancelable() && living.hasEffect(EffectRegistry.EFFECTSTUN.get())) {
            event.setCanceled(true);
        }
    }
    ...
    public void onBreakBlock(BlockEvent.BreakEvent event) {
        if (event.isCancelable() && event.getPlayer().hasEffect(EffectRegistry.EFFECTSTUN.get())) {
            event.setCanceled(true);
        }
    }
    ...
    public void onPlayerInteract(PlayerInteractEvent.LeftClickEmpty event) {
        ...
        if(!event.getEntity().hasEffect(EffectRegistry.EFFECTSTUN.get())){
    ...
    public void onLivingDamage(LivingDamageEvent event) {
        LivingEntity entity = event.getEntity();
        if (entity.getHealth() <= event.getAmount() && entity.hasEffect(EffectRegistry.EFFECTSTUN.get())) {
            entity.removeEffect(EffectRegistry.EFFECTSTUN.get());
        }
    ...
    public void onLivingAttack(CriticalHitEvent event) {
        ...
        if ((weapon.is(ItemRegistry.CHARGE_HALBERD.get()))) {
