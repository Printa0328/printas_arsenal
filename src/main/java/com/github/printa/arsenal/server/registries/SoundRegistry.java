...
public class SoundRegistry {
    ...
    public static final RegistryObject<SoundEvent> WEREWOLF_HURT = SOUNDS.register("werewolf_hurt",
            () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(Arsenal.MODID,"werewolf_hurt")));

    public static final RegistryObject<SoundEvent> SOUL_KNIGHT_HURT = SOUNDS.register("soul_knight_hurt",
            () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(Arsenal.MODID,"soul_knight_hurt")));

    public static final RegistryObject<SoundEvent> HALBERD_ATTACK_1 = SOUNDS.register("halberd_attack_1",
            () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(Arsenal.MODID,"halberd_attack_1")));

    public static final RegistryObject<SoundEvent> PHASE_CHANGE = SOUNDS.register("phase_change",
            () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(Arsenal.MODID,"phase_change")));

    public static final RegistryObject<SoundEvent> CAST_FIRE = SOUNDS.register("fire_cast",
            () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(Arsenal.MODID,"fire_cast")));
