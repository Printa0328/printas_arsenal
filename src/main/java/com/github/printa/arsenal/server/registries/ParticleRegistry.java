...
public class ParticleRegistry {
    ...
    public static final RegistryObject<Wisp2ParticleType> WISP2 = PARTICLE.register("wisp2", Wisp2ParticleType::new);
    ...
    public static final RegistryObject<ParticleType<RibbonParticleData>> FLAT_RIBBON = ParticleRegistry.registerRibbonParticle("flat_ribbon", RibbonParticleData.DESERIALIZER);
    public static final RegistryObject<ParticleType<AdvancedParticleData>> ADV_ORB = ParticleRegistry.registerAdvancedParticle("adv_orb", AdvancedParticleData.DESERIALIZER);
    public static final RegistryObject<ParticleType<AdvancedParticleData>> ADV_WISP = ParticleRegistry.registerAdvancedParticle("adv_wisp", AdvancedParticleData.DESERIALIZER);
    public static final RegistryObject<ParticleType<AdvancedParticleData>> ADV_SLASH = ParticleRegistry.registerAdvancedParticle("adv_slash", AdvancedParticleData.DESERIALIZER);
