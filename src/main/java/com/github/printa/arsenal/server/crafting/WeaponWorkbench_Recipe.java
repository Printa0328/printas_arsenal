package com.github.printa.arsenal.server.crafting;

import com.github.printa.arsenal.server.registries.BlockRegistry;
import com.github.printa.arsenal.server.registries.RecipeSerializersRegistry;
...
public class WeaponWorkbench_Recipe implements Recipe<Container> {
    final Ingredient base;
    final Ingredient addition;
    final ItemStack result;
    private final ResourceLocation id;

    public WeaponWorkbench_Recipe(ResourceLocation p_44523_, Ingredient p_44524_, Ingredient p_44525_, ItemStack p_44526_) {
        this.id = p_44523_;
        this.base = p_44524_;
    ...
    public ItemStack getToastSymbol() {
        return new ItemStack(BlockRegistry.WEAPON_WORKBENCH.get());
    }
    ...
    public RecipeSerializer<?> getSerializer() {
        return RecipeSerializersRegistry.WEAPON_WORKBENCH.get();
    }

    public RecipeType<?> getType() {
        return RecipeTypeRegistry.WEAPON_WORKBENCH.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<WeaponWorkbench_Recipe> {
        public WeaponWorkbench_Recipe fromJson(ResourceLocation p_44562_, JsonObject p_44563_) {
            ...
            return new WeaponWorkbench_Recipe(p_44562_, ingredient, ingredient1, itemstack);
        }

        public WeaponWorkbench_Recipe fromNetwork(ResourceLocation p_44565_, FriendlyByteBuf p_44566_) {
            ...
            return new WeaponWorkbench_Recipe(p_44565_, ingredient, ingredient1, itemstack);
        }

        public void toNetwork(FriendlyByteBuf p_44553_, WeaponWorkbench_Recipe p_44554_) {
