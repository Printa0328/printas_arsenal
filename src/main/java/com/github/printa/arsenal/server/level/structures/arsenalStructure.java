package com.github.printa.arsenal.server.level.structures;
...
public abstract class arsenalStructure extends Structure {
    ...
    public arsenalStructure(StructureSettings settings, Set<Holder<Biome>> allowedBiomes, boolean doCheckHeight, boolean doAvoidWater, boolean doAvoidStructures) {
        super(settings);
    ...
    public arsenalStructure(StructureSettings settings, Set<Holder<Biome>> allowedBiomes) {
        this(settings, allowedBiomes, true, true, true);
    }

    public arsenalStructure(StructureSettings settings) {
        super(settings);
    }
