...
public abstract class ParticleComponent {
    ...
    public void init(AdvancedParticleHelper particle) {

    }

    public void preUpdate(AdvancedParticleHelper particle) {

    }

    public void postUpdate(AdvancedParticleHelper particle) {

    }

    public void preRender(AdvancedParticleHelper particle, float partialTicks) {

    }

    public void postRender(AdvancedParticleHelper particle, VertexConsumer buffer, Camera renderInfo, float partialTicks, int lightmap) {
    ...
    public static class PropertyControl extends ParticleComponent {
        ...
        private void applyUpdate(AdvancedParticleHelper particle, float value) {
        ...
        private void applyRender(AdvancedParticleHelper particle, float value) {
    ...
    public static class Orbit extends ParticleComponent {
        ...
        private void apply(AdvancedParticleHelper particle, float t) {
