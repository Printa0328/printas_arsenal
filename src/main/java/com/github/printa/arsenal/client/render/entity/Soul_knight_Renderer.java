...
@OnlyIn(Dist.CLIENT)
public class Soul_knight_Renderer extends MobRenderer<Soul_knight_Entity, Soul_knight_Model> {
    ...
    public Soul_knight_Renderer(EntityRendererProvider.Context renderManagerIn) {
