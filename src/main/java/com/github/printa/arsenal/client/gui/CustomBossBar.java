...
public class CustomBossBar {
    ...
    static {
        ...
        customBossBars.put(0, new CustomBossBar(
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/monstrosity_bar_base.png"),
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/monstrosity_bar_overlay.png"),
                5, 16, 1,1, -2, -2, 256, 16, 25, 182,ChatFormatting.RED));
        //E.G
        customBossBars.put(1, new CustomBossBar(
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/ender_guardian_bar_base.png"),
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/ender_guardian_bar_overlay.png"),
                5, 16, 1,1, -2, -2, 256, 16, 25, 182,ChatFormatting.LIGHT_PURPLE));
        //Ignis 1 Phase
        customBossBars.put(2, new CustomBossBar(
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/ignis_bar_base.png"),
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/ignis_bar_overlay.png"),
                5, 16, 1,1, -2, -2, 256, 16, 25,182, ChatFormatting.YELLOW));
        //Ignis 2,3 Phase
        customBossBars.put(3, new CustomBossBar(
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/ignis_soul_bar_base.png"),
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/ignis_soul_bar_overlay.png"),
                5, 16, 1,1, -2, -2, 256, 16, 25, 182,ChatFormatting.DARK_AQUA));
        //harbinger
        customBossBars.put(4, new CustomBossBar(
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/harbinger_bar_base.png"),
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/harbinger_bar_overlay.png"),
                5, 16, 1,7, -2, -8, 256, 32, 25,182, ChatFormatting.DARK_RED));

        //Levi 1
        customBossBars.put(5, new CustomBossBar(
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/leviathan_bar_base.png"),
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/leviathan_bar_overlay.png"),
                5, 16, 1,2, -4, -4, 256, 16, 25, 182,ChatFormatting.DARK_PURPLE));
        //Levi 2
        customBossBars.put(6, new CustomBossBar(
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/leviathan_bar_base.png"),
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/leviathan_meltdown_bar_overlay.png"),
                5, 16, 1,4, -4, -6, 256, 16, 25, 182,ChatFormatting.DARK_PURPLE));

        //remnant
        customBossBars.put(7, new CustomBossBar(
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/remnant_bar_base.png"),
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/remnant_bar_overlay.png"),
                5, 16, 1,7, -4, -10, 256, 32, 30, 182,ChatFormatting.WHITE));
        //remnant rage
        customBossBars.put(8, new CustomBossBar(
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/remnant_rage_bar_base.png"),
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/remnant_rage_bar_overlay.png"),
                5, 16, 69,-8, -6,  -8, 256, 16, 15, 48,ChatFormatting.DARK_PURPLE));
        //maledictus health
        customBossBars.put(9, new CustomBossBar(
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/maledictus_bar_base.png"),
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/maledictus_bar_overlay.png"),
                5, 16, 1,7, -6, -9, 256, 32, 25,182, ChatFormatting.DARK_GREEN));

        //maledictus rage
        customBossBars.put(10, new CustomBossBar(
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/maledictus_rage_bar_base.png"),
                new ResourceLocation(Arsenal.MODID, "textures/gui/boss_bar/maledictus_rage_bar_overlay.png"),
    ...
    public void renderBossBar(CustomizeGuiOverlayEvent.BossEventProgress event) {
        ...
        int j = y - 9;
        Minecraft.getInstance().getProfiler().push("arsenalCustomBossBarBase");
        ...
        if (hasOverlay()) {
            Minecraft.getInstance().getProfiler().push("arsenalCustomBossBarOverlay");
