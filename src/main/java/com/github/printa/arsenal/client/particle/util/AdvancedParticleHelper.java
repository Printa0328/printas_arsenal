...
@OnlyIn(Dist.CLIENT)
public class AdvancedParticleHelper extends TextureSheetParticle {
    ...
    public static class Factory implements ParticleProvider<AdvancedParticleData> {
        ...
        public Particle createParticle(AdvancedParticleData typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            AdvancedParticleHelper particle;
            if (typeIn.isAnimation()) {
                particle = new AdvancedParticleHelper(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, typeIn.getRotation(), typeIn.getScale(), typeIn.getRed(), typeIn.getGreen(), typeIn.getBlue(), typeIn.getAlpha(), typeIn.getAirDiffusionSpeed(), typeIn.getDuration(), typeIn.isEmissive(), typeIn.getCanCollide(), typeIn.getComponents(), spriteSet);
                particle.setSpriteFromAge(spriteSet);
            } else {
                particle = new AdvancedParticleHelper(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, typeIn.getRotation(), typeIn.getScale(), typeIn.getRed(), typeIn.getGreen(), typeIn.getBlue(), typeIn.getAlpha(), typeIn.getAirDiffusionSpeed(), typeIn.getDuration(), typeIn.isEmissive(), typeIn.getCanCollide(), typeIn.getComponents(), null);
