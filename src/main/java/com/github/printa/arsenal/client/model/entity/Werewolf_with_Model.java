...
public class Werewolf_with_Model extends AdvancedEntityModel<Werewolf_Entity> {
	...
	public Werewolf_with_Model() {
		...
		setRotationAngle(right_arm, -0.8727F, 0.0873F, 0.1745F);
		...
		setRotationAngle(right_fore_arm, -2.0508F, 0.0F, -0.1745F);
		...
		setRotationAngle(right_fist, -0.1952F, -0.4532F, 0.0045F);
		...
		setRotationAngle(right_fist1, -0.1019F, -1.3687F, 0.0046F);
		...
		setRotationAngle(right_fist2, 1.133F, 0.0791F, -0.037F);
		...
		setRotationAngle(right_fist3, -0.1339F, 0.0226F, -1.308F);
		...
		setRotationAngle(right_fist4, -0.1745F, 0.0F, -1.2654F);
		...
		weapon.setTextureOffset(0, 0).addBox(-1.7246F, -48.0174F, -0.8235F, 3.0F, 85.0F, 3.0F, 0.0F, false);
		weapon.setTextureOffset(102, 14).addBox(-6.2246F, -67.0174F, 0.6765F, 12.0F, 18.0F, 0.0F, 0.0F, false);
		weapon.setTextureOffset(68, 17).addBox(-2.2246F, -47.0174F, -1.3235F, 4.0F, 2.0F, 4.0F, 0.0F, false);
		weapon.setTextureOffset(84, 17).addBox(-2.2246F, -49.0174F, -1.3235F, 4.0F, 1.0F, 4.0F, 0.0F, false);
		weapon.setTextureOffset(12, 23).addBox(0.2764F, -41.0174F, -14.8235F, 0.0F, 21.0F, 14.0F, 0.0F, false);
		weapon.setTextureOffset(12, 23).addBox(-1.5986F, -41.0174F, -14.8235F, 0.0F, 21.0F, 14.0F, 0.0F, false);

		cube_r36 = new AdvancedModelBox(this,"cube_r36");
		cube_r36.setRotationPoint(0.7764F, -22.8258F, -10.4992F);
		weapon.addChild(cube_r36);
		setRotationAngle(cube_r36, 0.6981F, 0.0F, 0.0F);
		cube_r36.setTextureOffset(12, 58).addBox(-2.4281F, -5.2989F, -7.0571F, 2.0F, 12.0F, 8.0F, 0.0F, false);

		cube_r37 = new AdvancedModelBox(this,"cube_r37");
		cube_r37.setRotationPoint(0.7754F, -36.0174F, -13.3235F);
		weapon.addChild(cube_r37);
		setRotationAngle(cube_r37, -0.3054F, 0.0F, 0.0F);
		cube_r37.setTextureOffset(40, 23).addBox(-2.4281F, -11.1644F, -1.5994F, 2.0F, 26.0F, 8.0F, 0.01F, false);
		...
		cube_r38.setTextureOffset(68, 17).addBox(-2.5F, -1.0F, -1.5F, 4.0F, 2.0F, 4.0F, 0.0F, false);
		...
		cube_r39.setTextureOffset(68, 17).addBox(-2.5F, -1.0F, -1.5F, 4.0F, 2.0F, 4.0F, 0.0F, false);
		...
		cube_r40.setTextureOffset(102, 14).addBox(-6.0F, -9.0F, 0.0F, 12.0F, 18.0F, 0.0F, 0.0F, false);
