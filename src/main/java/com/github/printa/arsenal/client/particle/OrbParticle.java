...
public class OrbParticle extends TextureSheetParticle {
    ...
    public OrbParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, double scale, int duration) {
        super(world, x, y, z);
    ...
    public static final class OrbFactory implements ParticleProvider<OrbData> {
        ...
        public Particle createParticle(OrbData typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            OrbParticle particle = new OrbParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, typeIn.getScale(), typeIn.getDuration());
