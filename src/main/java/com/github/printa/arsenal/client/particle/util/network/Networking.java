package com.github.printa.arsenal.client.particle.util.network;
...
public class Networking {
    ...
    public static void init() {
        INSTANCE = NetworkRegistry.newSimpleChannel(new ResourceLocation(Arsenal.MODID, "network"), () -> "1.0", (s) -> true, (s) -> true);
